...
<body>
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="dropdown">
                <a href="#" data-bs-toggle="dropdown" class="d-flex align-items-center">
                    <img src="{{ asset('assets/images/user.png') }}" class="rounded-circle border border-2"
                        style="width:45px; height:45px; object-fit:cover;">
                </a>
                <div class="dropdown-menu dropdown-menu-end shadow p-3" style="min-width:240px; border-radius:12px;">
                    <div class="d-flex align-items-center mb-2">
                        <img src="{{ asset('assets/images/user.png') }}" class="rounded-circle me-2"
                            style="width:35px; height:35px; object-fit:cover;">
                        <div>
                            <div class="fw-bold">{{ session('usuario.nombre') }}</div>
    ...
    <!-- CONTENT -->
    <div id="content">
        @include('components/dashboard/' . "$mod")
    </div>
    ...
    <script type="module" src="{{ asset('assets/js/modules/Dashboard/' . $mod . '.js') }}"></script>
